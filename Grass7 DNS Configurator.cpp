...
int InfoTaskFail(UINT uID, PCWSTR pszIcon)
{
	TaskDialog(NULL, NULL, gr7::LoadOSBrandingString(), gr7::LoadStringToW(GetModuleHandleW(NULL), IDS_INFO_HEADER), gr7::LoadStringToW(GetModuleHandleW(NULL), uID), TDCBF_CLOSE_BUTTON, pszIcon, NULL);
	exit(0);
}
...
int main(void)
{
	if(gr7::isProcessElevated(GetCurrentProcess()) != 1) {
		TaskDialog(NULL, NULL, gr7::LoadOSBrandingString(), gr7::LoadStringToW(GetModuleHandleW(NULL), IDS_INFO_HEADER), gr7::LoadStringToW(GetModuleHandleW(NULL), IDS_UAC_ERROR_TEXT), TDCBF_CLOSE_BUTTON, TD_ERROR_ICON, NULL);
		exit(0);
	}
	...
	int nClickedBtn;
	HICON hIcon = LoadIconW(GetModuleHandleW(NULL), MAKEINTRESOURCE(IDI_MAIN_ICON));
	LPCWSTR szTitle = gr7::LoadOSBrandingString(),
	  szHeader = gr7::LoadStringToW(GetModuleHandleW(NULL), IDS_HEADER),
	  szBodyText = gr7::LoadStringToW(GetModuleHandleW(NULL), IDS_BODY_TEXT);
	TASKDIALOG_BUTTON aCustomButtons[] = {
	  { 1000, gr7::LoadStringToW(GetModuleHandleW(NULL),IDS_BUTTON_START) },
	  { 1001, gr7::LoadStringToW(GetModuleHandleW(NULL),IDS_BUTTON_STOP) },
	  { 1002, gr7::LoadStringToW(GetModuleHandleW(NULL),IDS_BUTTON_ENABLE) },
	  { 1003, gr7::LoadStringToW(GetModuleHandleW(NULL),IDS_BUTTON_DISABLE) },
	  { 1004, gr7::LoadStringToW(GetModuleHandleW(NULL),IDS_BUTTON_EXIT) }
	};
